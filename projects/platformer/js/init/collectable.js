(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.db, 150, 45);
        collectable.create(type.max, 200, 180);
        collectable.create(type.steve, 600, 320);
        collectable.create(type.grace, 200, 468);
        collectable.create(type.kennedi, 700, 600)
